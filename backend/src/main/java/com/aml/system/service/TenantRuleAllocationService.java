...
public class TenantRuleAllocationService {
    ...
    public List<Map<String, Object>> getAllTenantAllocations() {
        String sql = """
                SELECT t.tenant_id, t.bank_name, t.is_active, a.rule_code, a.rule_name, a.allocated_at
                FROM aml_tenant_registry t
                LEFT JOIN aml_tenant_rule_allocations a ON a.tenant_id = t.tenant_id
                ORDER BY t.bank_name, t.tenant_id, a.rule_code
                """;
