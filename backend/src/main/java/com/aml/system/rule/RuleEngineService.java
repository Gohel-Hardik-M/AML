...
public class RuleEngineService {
    ...
    public List<RuleEvaluationResult> evaluate(Transaction transaction,
        ...
        if (transaction == null || activeConfigs == null || activeConfigs.isEmpty()) {
            log.debug("No AML rules evaluated because the transaction or active configuration is missing.");
            return Collections.emptyList();
        }
